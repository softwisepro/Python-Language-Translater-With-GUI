...
Screen = Tk()
Screen.title("Python Language Translator by:- EricKweyunga")
 
InputLanguageChoice = StringVar()
TranslateLanguageChoice = StringVar()

LanguageChoices = {'Hindi','English','French','German','Spanish', 'Kiswahili'}
InputLanguageChoice.set('English')
TranslateLanguageChoice.set('kiswahili')
